...
export const Sync_AsyncStateContextReason = {
...
export type Sync_AsyncStateContextReason =
  (typeof Sync_AsyncStateContextReason)[keyof typeof Sync_AsyncStateContextReason];
