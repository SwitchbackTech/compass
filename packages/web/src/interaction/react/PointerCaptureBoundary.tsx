...
import { type InteractionCancellationTargets } from "../interaction.engine";
...
interface Props extends PropsWithChildren {
  adapter: PointerCaptureAdapter;
}

export const PointerCaptureBoundary: FC<Props> = ({ adapter, children }) => {
