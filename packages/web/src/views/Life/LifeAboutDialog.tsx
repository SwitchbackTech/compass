  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-9 w-9 items-center justify-center rounded text-text-muted transition-colors hover:bg-surface-panel hover:text-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background"
      ...
      {isOpen ? (
        <OverlayPanel
          ...
          variant="modal"
        >
          <div className="flex w-full flex-col gap-4 text-sm text-text-muted">
            <p>
