...
export const getValidDateFromUrl = (
  ...
  // Fallback to today's date - get today's date at midnight in user's timezone, then convert to UTC
  // while preserving the calendar date (using keepLocalTime=true)
