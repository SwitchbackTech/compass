...
])(`CompassToGoogleEventPropagation - $calendarProvider calendar: ${RecurringEventUpdateScope.THIS_EVENT} - Regular Event: `, ({
  calendarProvider,
}) => {
        ...
        expect.arrayContaining([
          {
            ...
            transition: ["STANDALONE_SOMEDAY", "STANDALONE_SOMEDAY_CANCELLED"],
            category: Categories_Recurrence.STANDALONE_SOMEDAY,
