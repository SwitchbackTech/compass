...
import { createCompassSeriesFromGcalBase } from "@backend/sync/services/event-propagation/__tests__/google-to-compass.event-propagation.test.util";
...
describe("GoogleToCompassEventPropagation: DELETE", () => {
  ...
  it("should delete a STANDALONE event", async () => {
    ...
    const processor = new GoogleToCompassEventPropagation(user._id.toString());
