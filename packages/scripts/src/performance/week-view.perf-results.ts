export type BrowserMetricSummary = {
  ...
  weekInteraction?: WeekInteractionMetricSummary;
};

export type WeekInteractionMetricSummary = {
  available: boolean;
  ...
  unexpectedDomMutationTargets: string[];
  unexpectedDomMutationsDuringMotion: number;
};
