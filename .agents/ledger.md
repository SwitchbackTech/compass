...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 3212 | high | Verifier | verifying | .github/scripts/agent-loop-next.sh | bash agent-loop-next.test.sh passed=8; merge-guard.test.sh passed=8 | 2026-09-04T08:00:00Z | 0 | human |
