...
work package from GitHub to squash-merged `main` without waiting for a
...
human-merged: open the PR, add `agent-loop-needs-human`, comment what
needs the founder's eyes, and continue to the next eligible issue.
